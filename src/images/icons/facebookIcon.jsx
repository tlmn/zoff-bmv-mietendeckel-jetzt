...
const FaceBookIcon = ({ width, isYellow }) => (
  <svg width={width} viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#a)">
      <path d="m35 17.406c0 9.349-7.8353 16.928-17.5 16.928-9.6647 0-17.5-7.5794-17.5-16.928 0-9.3491 7.8353-16.928 17.5-16.928 9.6647 0 17.5 7.5794 17.5 16.928z" />
      <path
