      ...
      <div className="container mx-auto d-block">
        <div className="row mb-3">
          <div className="col-12 text-center">
            <h2
              className="circle circle--congress-blue"
              style={{ hyphens: "none" }}
            >
        ...
        <div className="row">
          <div className="col-lg-8 offset-lg-2">
            <p className="teaser mb-3 md-md-5 pb-3 pt-md-5 pt-3">
              ...
              dieser Entwicklung weitestgehend tatenlos zugesehen.
        ...
        <div className="row contentItems">
          <div className="col-12 col-lg-4 pb-4 pb-md-0">
            <h3>Hohe Mieten bei neuen Mietverträgen</h3>
            <p className="text--small-running--wo-circle">
              ...
              Euro/qm nettokalt im Schnitt sind für viele nur unter großen
              Einschränkungen leistbar, für manche Menschen leider gar nicht.
              Bis zu 10 Prozent sind die Mieten pro Jahr bei Wiedervermietung
              angestiegen. Für eine Wohnung innerhalb des S-Bahn-Ringes braucht
              es jetzt zumeist ein überdurchschnittliches Einkommen. Eine „Stadt
              für alle“ stellen wir uns anders vor.
            </p>
          </div>
          <div className="col-12 col-lg-4 pb-4 pb-md-0">
            <h3>Mieterhöhungen bedrohen das Mietverhältnis</h3>
            <p className="text--small-running--wo-circle">
          ...
          <div className="col-12 col-lg-4">
            ...
            <p className="text--small-running--wo-circle">
              ...
              lässt immer noch Mieterhöhungen bis zu 3 Euro/qm zu. Für eine 70
              Quadratmeter große Wohnung also bis zu 210 Euro im Monat. Solche
              Mieterhöhungen sind eine komplette Änderung des Mietverhältnisses
