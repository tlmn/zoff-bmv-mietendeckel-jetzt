      ...
      <div className="row">
        ...
        <div className="col-lg-8 offset-lg-2 offset-0 col-12">
          <p className="teaser pb-5 pt-3">
            ...
            dauerhaft bezahlbar und verfügbar bleiben. Darum ist der
            Mietendeckel der Auftakt für eine Wende in der Wohnungspolitik, die
            viel zu lange Interessen von Spekulant*innen vor Mieter*innen
            gestellt hat.
          </p>
        </div>
      </div>
      <div className="row">
        <div className="col-12 col-lg-4">
          ...
          <p>
            ...
            nostrud magna consectetur occaecat in ipsum cupidatat nisi. Nostrud
            ea non aliquip laboris anim. Ad ullamco commodo ut cillum. Commodo
            officia in eiusmod labore ex sunt non duis sit.
          </p>
        </div>
        <div className="col-12 col-lg-4">
          ...
          <p>
            ...
            ut est dolor quis commodo sit. Id sint fugiat laborum aliqua
            voluptate laborum quis do eiusmod elit sint consequat. Ut qui minim
            aliquip qui adipisicing ullamco cillum cillum culpa.
          </p>
        </div>
        <div className="col-12 col-lg-4">
