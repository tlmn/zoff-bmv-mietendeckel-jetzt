          ...
          <Accordion
            items={[
              ...
              },
              {
                ...
                link: "/",
                text:
                  "Zum Anwendungsbereich des Mietendeckels gehören rund 1,5 Millionen Berliner Mietwohnungen. Der Mietendeckel gilt nicht bei:<ul><li>Neubauwohnungen, die erstmalig ab dem 1.1.2014 bezugsfertig wurden, Wohnungen, die dauerhaft unbewohnbar und unbewohnt waren und mit Neubauaufwand wieder hergestellt wurden,</li><li>öffentlich geförderten Wohnungen (Sozialwohnungen),</li><li>Wohnungen, die mit öffentlichen Mitteln instandgesetzt und modernisiert wurden und einer Mietpreisbindung unterliegen,</li><li>Wohnraum in Wohnheimen,</li><li>Wohnungen von Trägern der Wohlfahrtspflege.</li></ul>"
              },
              {
                title:
