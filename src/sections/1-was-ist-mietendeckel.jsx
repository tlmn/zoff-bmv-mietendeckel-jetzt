        ...
        <div className="row contentItems">
          <div className="col-12 col-lg-4">
            ...
            <p className="text--small-running">
              <span className="font-weight-bold mr-2">Seit 23.2.2020</span>
              ...
              die Mieter*innen umgelegt werden: mit höchstens 1 Euro/qm im
              Monat. Endlich keine Angst mehr vor Mieterhöhungen!
            </p>
          </div>
          <div className="col-12 col-lg-4">
            ...
            <p className="text--small-running">
              ...
              besonders stark – trotz Mietpreisbremse. Das verhindert jetzt der
              Mietendeckel. Er legt Obergrenzen für Mietpreise bei
              Wiedervermietungen fest. Diese richten sich nach Baujahr des
              Hauses und Ausstattung. Vermieter*innen sind verpflichtet, diese
